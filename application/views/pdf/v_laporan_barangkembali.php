...
<html lang="en">
    ...
    <table width="100%">
        ...
        <div style="text-align:center">
            <h3> Laporan Transaksi Barang Kembali</h3>
        ...
        <table id="table">
            ...
            <?php
                $no = 1;
                if ($query)
                    foreach ($query as $bkm) {
                    ?>
                    <tr>
                        <td style= "text-align: center;"><?php echo $no++; ?></td>
                        <td style= "text-align: left"><?php echo date('d-M-Y', strtotime($bkm['tanggal_keluar'])) ?></td>
                        <td style= "text-align: left"><?php echo $bkm['id_barangkeluar']; ?></td>
                        <td style= "text-align: left"><?php echo date('d-M-Y', strtotime($bkm['tanggal_kembali'])) ?></td>
                        <td style= "text-align: left"><?php echo $bkm['jumlah_kembali']; ?></td>
                        <td style= "text-align: left"><?php echo $bkm['keterangan']; ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
