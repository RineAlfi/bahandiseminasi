                                    ...
                                    <?php
                                        ...
                                        if ($barangmasuk)
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Yakin hapus data ini?')" id="hapusmasuk" class="btn btn-sm btn-danger" href="<?php echo site_url('/barangmasuk/hapus/' . $bm['id_barangmasuk']) ?>"><i class="ti ti-trash"></i></a>
                                            </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
