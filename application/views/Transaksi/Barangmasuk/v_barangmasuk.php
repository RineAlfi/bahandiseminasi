        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="card shadow mb-4">
                    ...
                    <h4 class="m-0 font-weight-bold">Data Barang Masuk</h4><br>
                    ...
                    <!-- <div class="col-md-12 grid-margin"> -->
                        <div class="card shadow mb-12">
                            ...
                            <div class="card mb-3">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered table-md margin:top-50%" style="width:100%">
